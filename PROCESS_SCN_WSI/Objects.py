...
class HistoImage(tf.keras.utils.Sequence):
    ...
    def GetThumbnails(self):
        ...
        self.ThumbnailImage=Image.fromarray(self.image.read_block((0,0,rect_1[2],rect_1[3]),(rect_1[2]//100,rect_1[3]//100)))
    ...
    def GenerateMask(self):
        ...
        self.ThumbnailMask=Image.fromarray(cv2.resize( self.mask, (dim[1]//100,dim[0]//100))).rotate(90,expand=True)
    ...
    def __getitem__(self, idx):
        ...
        X_batch = [np.array(Image.fromarray(self.image.read_block(x_b)).resize(self.target_size)) for x_b in X_batch_tmp]
...
UnitTest=False
if UnitTest:
    img=HistoImage("../Prostate/Slide-0031718_TI05136 4001.svs", verbose=1299)
    print(len(img))
    for batch in img:
