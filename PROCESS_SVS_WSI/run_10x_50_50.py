...
if __name__=="__main__":
    ...
    data={"filename":[],
    "score":[]}
    X=HistoImage(fln, batch_size=16, target_magnification=10,overlap_rate=(0.5,0.5)) #REQUIRED MORE MEMORY AND MAY CAUSE OUT OF MEMORY ERROR - TESTED SUCCESSFULLY ON 128GB RAM
    ...
    pd.DataFrame(data).to_csv(fr"../outcome/{config}/csv_prostate/{fl_csv}", index=False)